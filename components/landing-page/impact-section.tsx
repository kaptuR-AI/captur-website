const ImpactSection = () => {
    return (
        <div className="p-4 max-w-7xl m-auto">
            ...
            <div className="p-7 rounded-3xl justify-between border border-white bg-custom-gradient text-black grid lg:grid-cols-3 sm:grid-col-1 md:grid-cols-3 gap-4  ">
